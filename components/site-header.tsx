...
const features = [
...
},
  {
    ...
    description: "Integrated messaging system with multi-channel notifications for seamless schoo-wide communication",
...
},
  {
    ...
    description: "Real-time transport tracking, route management, and automated notofications for safe student transportation",
